...
import { LogOut, ClipboardList, PlusCircle } from "lucide-react";
            ...
            {mounted && isLoggedIn ? (
              <>
                <Link href="/my-complaints">
                  <span className="hidden sm:flex items-center gap-2 text-sm font-medium text-gray-500 hover:text-gray-900 bg-gray-50 hover:bg-gray-100 border border-gray-200 px-4 py-2 rounded-xl transition-all">
              ...
              <>
                <Link href="/login">
                  <span className="text-sm font-medium bg-gray-50 hover:bg-gray-100 border border-gray-200 px-4 py-2 rounded-xl text-gray-600 hover:text-gray-900 transition-all hidden sm:block">
                    Login
                  </span>
                </Link>
                <Link href="/report">
